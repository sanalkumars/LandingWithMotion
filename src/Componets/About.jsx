  ...
  return (
    <section className="container mx-auto mb-8" id='about'>
        ...
        <div className="flex flex-wrap">
            <div className="w-full p-4 lg:p-8 lg:w-1/2">
            ...
            className="mb-2 mt-1 h-2 w-36 bg-rose-300 lg:-rotate-3"> </motion.div>
            <motion.p 
             initial={{opacity:0 , y:50}}
             whileInView={{opacity:1 , y:0}}
             viewport={{once:true}}
             transition={{duration:0.6 , delay:0.6}}
            className="m-2 text-2xl leading-relaxed tracking-tight lg:max-w-xl">{ABOUT.content} </motion.p>
            </div>
        </div>
    </section>
  )
